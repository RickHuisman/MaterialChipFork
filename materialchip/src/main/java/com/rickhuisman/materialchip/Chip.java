package com.rickhuisman.materialchip;
...
import static com.rickhuisman.materialchip.ChipUtils.IMAGE_ID;
import static com.rickhuisman.materialchip.ChipUtils.TEXT_ID;
import static com.rickhuisman.materialchip.ChipUtils.generateText;
import static com.rickhuisman.materialchip.ChipUtils.getCircleBitmap;
import static com.rickhuisman.materialchip.ChipUtils.getCircleBitmapWithText;
import static com.rickhuisman.materialchip.ChipUtils.getScaledBitmap;
import static com.rickhuisman.materialchip.ChipUtils.getSquareBitmap;
import static com.rickhuisman.materialchip.ChipUtils.setIconColor;
...
public class Chip extends RelativeLayout {
    ...
    private void selectChip(View v) {
        ...
        initBackgroundColor();
        initTextView();
        selectIcon.setImageResource(R.drawable.ic_check_circle_24dp);
